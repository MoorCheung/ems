	...
	<div id="">
		...
		<div style='margin-top: 20px;'>
			<el-table border style="width: 100%" :data="list">
				<el-table-column fixed prop="faultId" label="ID" width="220">
				</el-table-column>
				<el-table-column fixed prop="devname" label="设备名称" width="220">
				</el-table-column>
				<el-table-column fixed prop="cause" label="故障原因" width="220">
				</el-table-column>
				<el-table-column fixed prop="faultuser" label="报告人" width="220">
				</el-table-column>
				<el-table-column fixed prop="faulttime" label="故障时间(分钟)" width="220">
				</el-table-column>
...
<script>
	export default {
		...
		methods: {
			...
			update(row){
					this.$router.push({name:'FaultEdit',params:{row:row.faultId}});  //传递row参数给后方修改页面，方便后方页面接收数据并进行回显
			},
			del(faultId){
				// 后端网址
